...
Figure~\ref{fig:dataset_samples} shows examples of handwritten
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{Model A.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{Model B.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{accuracy_vs_model.png}
...
It achieved 94.35\% accuracy with only 2.1431 MB of model storage.
